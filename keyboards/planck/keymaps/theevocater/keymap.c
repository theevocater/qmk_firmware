 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Alt  |  `   | Alt  | GUI  |Lower |Bspace| Space|Raise |      |   [  |   ]  |      |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LALT, KC_GRV, KC_RALT, KC_LGUI, LOWER,   KC_BSPC,  KC_SPC,  RAISE,   _______, KC_LBRC, KC_RBRC,  _______
),
 ...
 * |   =  |   1  |   2  |   3  |   4  |   5  |   6  |   7  |   8  |   9  |   0  |  -   |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Del  |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  | HOME |Pg Dn |Pg Up | END  |  \   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
